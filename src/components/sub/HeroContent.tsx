    ...
    >
      ...
      <motion.div variants={itemVariants} className="space-y-6">
        ...
        <div className="relative">
          <h1 title='name' className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-black tracking-tight">
            <span title='name' className="bg-gradient-to-r from-foreground via-primary to-teal-500 bg-clip-text text-transparent">
              {site.name}
            </span>
          </h1>
          ...
          <div className="absolute -bottom-2 -left-2 w-6 h-6 bg-teal-500/30 rounded-full animate-pulse"></div>
        </div>

        {/* Role with Modern Design */}
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-r from-primary/10 via-teal-500/10 to-primary/10 rounded-2xl blur-xl"></div>
          <div className="relative bg-card/40 backdrop-blur-sm border border-primary/20 rounded-2xl p-6 shadow-2xl">
            <h2 title={t.site.role} className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-primary via-teal-500 to-primary bg-clip-text text-transparent mb-3">
              {t.site.role}
            </h2>
            {t.site.roleSubtitle ? (
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-primary to-teal-500 rounded-full mx-auto"></div>
          </div>
        </div>
      ...
      >
        <NavbarButton
          ...
          variant="primary"
          className="group relative overflow-hidden bg-gradient-to-r from-primary to-teal-500 hover:from-teal-500 hover:to-primary text-primary-foreground px-8 py-4 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
        ...
        >
          ...
          <div title={t.hero.connect} className="absolute inset-0 bg-white/20 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></div>
        </NavbarButton>
